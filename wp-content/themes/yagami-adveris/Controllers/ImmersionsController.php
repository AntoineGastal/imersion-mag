...
class ImmersionsController extends AppController
{
	/**
	 * __Constructor:
	*
	...
	*/
	public function archiveAction(){
		$this->render('immersions/archive.twig', array(
	...
	*/
	public function singleAction(){
		$this->render('immersions/single.twig', array(
			'post' => new TimberPost()
		));
	}
	 ...
	 * Method called by Router::routing()
	*
	* typesAction() method renders <projects/types.twig> and provide it some datas
	*
	* @return void
	*/
	public function typesAction(){
		$this->render('immersions/types.twig', array(
			'posts' => new Timber\PostQuery(),
